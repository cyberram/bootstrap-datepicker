...
test('Selecting date from previous month while in January changes month and year displayed', function(){
    ...
    equal(this.widget.find('.datepicker-days thead th.datepicker-switch').text(), 'January 2011');

    // Updated internally on click
    target.click();
    equal(this.widget.find('.datepicker-days thead th.datepicker-switch').text(), 'December 2010');
