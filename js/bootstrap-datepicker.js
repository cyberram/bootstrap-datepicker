 ...
 * Improvements by Ramkumar Krishnamoorthy
 *
...
!function ($) {
    ...
    var Datepicker = function (element, options) {
        ...
        this.widget = $(getTemplate(this.o.timeIcon, options.pickDate, options.pickTime, options.pick12HourFormat, options.pickSeconds, options.collapse)).appendTo('body');
        this._buildEvents();
        this._attachEvents();
        ...
        if (this.o.calendarWeeks)
            this.widget.find('tfoot th.today')
    ...
    Datepicker.prototype = {
				...
				[$(document), {
				    mousedown: $.proxy(function (e) {
				        ...
				        if (!(
							...
							this.widget.find(e.target).size()
						)) {
				            this.hide();
				        }
				    }, this)
				}],
                [this.widget.find('.accordion-toggle'), {
                    'click.togglePicker': $.proxy(this.togglePicker, this)
                }],
                [this.widget.find('[data-action]'), {
        ...
        togglePicker: function (e) {
            ...
            var closed = this.widget.find('.collapse:not(.in)');
            ...
            if (expanded && expanded.length) {
                ...
                this.element.find('> .add-on > i').toggleClass(self.timeIcon + ' ' + self.dateIcon);
                this.element.find('.add-on i').toggleClass(self.timeIcon + ' ' + self.dateIcon);
            }
        },
        ...
        show: function (e) {
			...
			var wasClosed = this.widget.is(':visible');
            this.widget.show();
			
			// Reset the view to default date/time pickers
            this.height = this.component ? this.component.outerHeight() : this.element.outerHeight();
			if(this.o.pickTime && !wasClosed) {
        ...
        fillDow: function () {
            ...
            if (this.o.calendarWeeks) {
                ...
                html += cell;
                this.widget.find('.datepicker-days thead tr:first-child').prepend(cell);
            }
        ...
        fillDate: function () {
            ...
            this.widget.find('tfoot th.clear')
            ...
            switch (this.viewMode) {
                case 0:
                    if (this.o.startDate !== -Infinity && year <= this.o.startDate.getUTCFullYear() && month <= this.o.startDate.getUTCMonth()) {
                        this.widget.find('.prev').css({ visibility: 'hidden' });
                    } else {
                        this.widget.find('.prev').css({ visibility: 'visible' });
                    }
                    if (this.o.endDate !== Infinity && year >= this.o.endDate.getUTCFullYear() && month >= this.o.endDate.getUTCMonth()) {
                        this.widget.find('.next').css({ visibility: 'hidden' });
                    } else {
                        this.widget.find('.next').css({ visibility: 'visible' });
                    }
                    break;
                case 1:
                case 2:
        ...
        showMode: function (dir) {
            ...
            */
            ...
            this.widget.find('.datepicker > div').hide().filter('.datepicker-' + DPGlobal.modes[this.viewMode].clsName).css('display', 'block');
            this.updateNavArrows();
        },
    ...
    var TPGlobal = {
        hourTemplate: '<span data-action="showHours" data-time-component="hours" class="timepicker-hour focused"></span>',
